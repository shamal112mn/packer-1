  ...
  try {
    properties([
      ...
      parameters([
        ...
        booleanParam(defaultValue: true, description: 'Click this if you would like to deploy the image', name: 'TRIGGER_DEPLOY'),
        ...
        container('fuchicorptools') {
          ...
          if (params.TRIGGER_DEPLOY) {
            stage("Trigger Deploy") {
              ...
              echo "#############################################################"
              println("         The job is a push only job !!!")
              println("The image has been built and pushed to Nexus !!!")  
              echo "#############################################################"
